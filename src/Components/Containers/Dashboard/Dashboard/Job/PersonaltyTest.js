...
import SubmitKontrak from './Modal/PersonaltyTest/SubmitKontrak'
import SubmitedKontrak from './Modal/PersonaltyTest/SubmitedKontrak'

const PersonaltyTest = () => {
