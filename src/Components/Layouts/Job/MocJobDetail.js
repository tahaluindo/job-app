...
class MocJobDetail extends React.Component {
    render() {
        ...
        const handleButton = () => {
            window.location.href = '/MocDaftar'
        }
        return (
            <Container>
                <Grid
                ...
                >
                    ...
                    >
                        <Button
                            ...
                            style={{ border: '0px solid red', width: '100%', padding: '5%', borderRadius: '50px', backgroundColor: 'blue', fontSize: "16px", color: 'white' }}
                        >
                            Daftar Sekarang
                        </Button>
                    </div>
